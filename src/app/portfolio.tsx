...
import { ArrowRight, ArrowUpRight, Briefcase02, CalendarDate, Code02, IntersectSquare, Mail01, MessageChatCircle, Moon01, PlayCircle, Sun, User01 } from "@untitledui/icons";
...
const JoshuaLogo = () => {
    return (
        <div className="flex items-center gap-0">
            <IntersectSquare className="size-10 text-primary" />
